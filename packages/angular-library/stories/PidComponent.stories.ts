...
import { PidComponent } from '../lib/stencil-generated/components';

const meta: Meta<PidComponent> = {
  title: 'PidComponent',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Angular standalone wrapper for the PID Component. Install via `npm install @kit-data-manager/angular-pid-component`.',
      },
    },
  },
  argTypes: {
...
export const SystemMode: Story = {
  args: { value: '10.5445/ir/1000185135', darkMode: 'system' },
};
