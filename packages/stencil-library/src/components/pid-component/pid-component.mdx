...
- [1. Persistent Identifiers (Handles)](#1-persistent-identifiers-handles)
- [2. Digital Object Identifiers (DOIs)](#2-digital-object-identifiers-dois)
- [3. ORCiD](#3-orcid-open-researcher-and-contributor-id)
- [4. ROR](#4-research-organization-registry-ror)
- [5. SPDX Licenses](#5-spdx-licenses)
- [6. JSON Data](#6-json-data)
- [7. Locales & Flags](#7-locales--flags)
- [8. Dates](#8-dates)
- [9. URLs & E-Mails](#9-urls--e-mails)
