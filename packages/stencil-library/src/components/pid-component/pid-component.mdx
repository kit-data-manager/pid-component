...
- DOIs (with DataCite or CrossRef metadata; resolvable via [doi.org](doi.org))
- ORCiDs (resolvable via [orcid.org](orcid.org))
- RORs (resolvable via [ror.org](ror.org))
- SPDX license identifiers/URLs
- URLs (starting with http:// or https://)
- Email-addresses (separated by comma)
- Dates
- JSON objects
- Locales (e.g. en-US, de-DE)
