...
|-------------------------------|----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|-----------------------|
| `adaptivePagination`          | `adaptive-pagination`            | Enable adaptive pagination based on available space. When true, amountOfItems becomes the initial/minimum value.                                                                                                                                                                                                                                       | `boolean` | `false`               |
...
| `estimatedRowHeight`          | `estimated-row-height`           | Estimated height of each table row in pixels (used for adaptive pagination).                                                                                                                                                                                                                                                                           | `number`  | `40`                  |
...
| `maxItemsPerPage`             | `max-items-per-page`             | Maximum number of items to show per page when using adaptive pagination.                                                                                                                                                                                                                                                                               | `number`  | `50`                  |
| `minItemsPerPage`             | `min-items-per-page`             | Minimum number of items to show per page when using adaptive pagination.                                                                                                                                                                                                                                                                               | `number`  | `5`                   |
