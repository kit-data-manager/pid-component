...
<script>
  document.querySelector('pid-actions').actions = [
    { priority: 1, title: "Primary Action", link: "https://example.com/primary", style: "primary" },
    { priority: 2, title: "Secondary Action", link: "https://example.com/secondary", style: "secondary" },
    { priority: 3, title: "Danger Action", link: "https://example.com/danger", style: "danger" },
    { priority: 4, title: "Another Primary", link: "https://example.com/another", style: "primary" },
    { priority: 5, title: "Another Secondary", link: "https://example.com/another-secondary", style: "secondary" },
