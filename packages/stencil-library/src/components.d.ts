...
export namespace Components {
    ...
    interface PidComponent {
        ...
        /**
          * The dark mode setting for the component Options: "light", "dark", "system" Default: "light" for better compatibility
          * @type {string}
          * @default 'light'
         */
        "darkMode": 'light' | 'dark' | 'system';
...
declare namespace LocalJSX {
    ...
    interface LocaleVisualizationAttributes {
        "locale": string;
        "showFlag": boolean;
    }
    interface PidActionsAttributes {
        "actionsId": string;
        "darkMode": 'light' | 'dark' | 'system';
    }
    interface PidCollapsibleAttributes {
        "open": boolean;
        "emphasize": boolean;
        "darkMode": 'light' | 'dark' | 'system';
        "initialWidth": string;
    ...
    interface PidTooltipAttributes {
        "text": string;
        "position": 'top' | 'bottom';
        "maxWidth": string;
        "maxHeight": string;
    ...
    interface IntrinsicElements {
        "color-highlight": Omit<ColorHighlight, keyof ColorHighlightAttributes> & { [K in keyof ColorHighlight & keyof ColorHighlightAttributes]?: ColorHighlight[K] } & { [K in keyof ColorHighlight & keyof ColorHighlightAttributes as `attr:${K}`]?: ColorHighlightAttributes[K] } & { [K in keyof ColorHighlight & keyof ColorHighlightAttributes as `prop:${K}`]?: ColorHighlight[K] } & OneOf<"text", ColorHighlight["text"]>;
        "copy-button": Omit<CopyButton, keyof CopyButtonAttributes> & { [K in keyof CopyButton & keyof CopyButtonAttributes]?: CopyButton[K] } & { [K in keyof CopyButton & keyof CopyButtonAttributes as `attr:${K}`]?: CopyButtonAttributes[K] } & { [K in keyof CopyButton & keyof CopyButtonAttributes as `prop:${K}`]?: CopyButton[K] } & OneOf<"value", CopyButton["value"]>;
        ...
        "pid-collapsible": Omit<PidCollapsible, keyof PidCollapsibleAttributes> & { [K in keyof PidCollapsible & keyof PidCollapsibleAttributes]?: PidCollapsible[K] } & { [K in keyof PidCollapsible & keyof PidCollapsibleAttributes as `attr:${K}`]?: PidCollapsibleAttributes[K] } & { [K in keyof PidCollapsible & keyof PidCollapsibleAttributes as `prop:${K}`]?: PidCollapsible[K] };
        "pid-component": Omit<PidComponent, keyof PidComponentAttributes> & { [K in keyof PidComponent & keyof PidComponentAttributes]?: PidComponent[K] } & { [K in keyof PidComponent & keyof PidComponentAttributes as `attr:${K}`]?: PidComponentAttributes[K] } & { [K in keyof PidComponent & keyof PidComponentAttributes as `prop:${K}`]?: PidComponent[K] };
        ...
        "pid-tooltip": Omit<PidTooltip, keyof PidTooltipAttributes> & { [K in keyof PidTooltip & keyof PidTooltipAttributes]?: PidTooltip[K] } & { [K in keyof PidTooltip & keyof PidTooltipAttributes as `attr:${K}`]?: PidTooltipAttributes[K] } & { [K in keyof PidTooltip & keyof PidTooltipAttributes as `prop:${K}`]?: PidTooltip[K] } & OneOf<"text", PidTooltip["text"]>;
    }
}
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
             ...
             * with resize capability and cross-browser compatibility
             */
            "pid-collapsible": LocalJSX.IntrinsicElements["pid-collapsible"] & JSXBase.HTMLAttributes<HTMLPidCollapsibleElement>;
            "pid-component": LocalJSX.IntrinsicElements["pid-component"] & JSXBase.HTMLAttributes<HTMLPidComponentElement>;
