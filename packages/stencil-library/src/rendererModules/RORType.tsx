...
export class RORType extends GenericIdentifierType {
  ...
  renderPreview(): FunctionalComponent {
    ...
    if (!this.rorData) {
      return <span class={`font-mono text-sm ${this.isDarkMode ? 'text-gray-300' : ''}`}>Loading ROR: {this.value}...</span>;
    }
      ...
      <span class={`inline-flex flex-nowrap items-center align-top font-mono ${this.isDarkMode ? 'text-gray-200' : ''}`}>
        ...
        >
          <g transform="matrix(0.994301,0,0,0.989352,0,0)">
            <rect x="0" y="0" width="164.94" height="119.27" style={{ fill: this.isDarkMode ? 'rgb(31, 41, 55)' : 'white' }} />
          </g>
          <g transform="matrix(1,0,0,1,-0.945,-0.815)">
            ...
            <path
              ...
              style={{ fill: this.isDarkMode ? 'rgb(229, 231, 235)' : 'rgb(32,40,38)', fillRule: 'nonzero' }}
            />
          </g>
        </svg>
