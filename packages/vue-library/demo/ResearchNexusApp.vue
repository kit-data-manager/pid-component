  ...
  <v-app>
    ...
    <v-main style="background: #f5f5f5;">
      <v-container fluid class="pa-8">
        ...
        <ArticleSection class="mb-6" />

        <div class="mb-6">
          <div class="d-flex align-center mb-4">
            <v-icon color="warning" class="mr-2">mdi-chart-bar</v-icon>
            <span class="text-h6 font-weight-bold">Interactive Components</span>
            <v-chip color="warning-lighten-5" text-color="warning-darken-3" size="small" class="ml-3">
