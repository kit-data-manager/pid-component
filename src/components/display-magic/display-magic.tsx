            ...
            <Host class="inline flex-grow max-w-full font-sans flex-wrap">
                {
                    ...
                    this.items.length === 0 && this.actions.length === 0
                        ...
                        : <details
                            ...
                            <summary
                                class="mx-2 select-none list-inside bg-white overflow-x-hidden space-x-3 max-w-screen-sm flex-none">
                                <span class={"flex-initial font-mono inline-flex flex-nowrap max-w-xl overflow-x-scroll align-top"}>{
                                ...
                                this.currentLevelOfSubcomponents === 0
                                    ? <button
                                        class={"bg-white border border-slate-500 text-slate-800 font-medium font-mono text-sm rounded-md px-2 py-0.5 hover:bg-blue-200 hover:text-slate-900 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-blue-500 flex-none max-h-min align-baseline mr-2"}
                                ...
                                this.items.length > 0
                                    ? <div>
                                                                ...
                                                                <td class={"overflow-x-scroll p-1 w-1/4 font-mono"}>
                                                                    <a role="link"
                                                                       ...
                                                                       onMouseOut={this.hideTooltip}>
                                                                        <div
                                                                            class="cursor-pointer align-top justify-between flex-nowrap">
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="hidden sm:flex sm:flex-1 sm:flex-nowrap sm:items-center sm:justify-between text-sm">
                                                <div class={""}>
                                                    <p class="text-sm text-gray-700">
                                                        Showing
                                                        <span
                                                            class="font-medium"> {1 + this.tablePage * this.amountOfItems} </span>
                                                        to
                                                        <span
