...
<Canvas of={DisplayMagicStories.ORCIDInRecordWithSettings} />

## No subcomponents
You can also prohibit the unfolding of the component by setting the `currentlevelOfSubcomponents` to the same value as the `levelOfSubcomponents` property.
Alternatively, simply set the attribute `hideSubcomponents`.
<Canvas of={DisplayMagicStories.HandleWithoutSubcomponent} />
...
<Canvas of={DisplayMagicStories.HandleWithoutSubcomponentInText} />
