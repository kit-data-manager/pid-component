...
declare global {
  ...
  interface HTMLElementTagNameMap {
    "color-highlight": HTMLColor'color-highlight'
    "copy-button": HTMLCopyButto'copy-button' "locale-visualization": HTML'locale-visualization'ment;
    "pid-component": HTMLPidComp'pid-component' }
}
